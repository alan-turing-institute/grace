...
expected_end_coords_float = [
    ...
    np.array([[5.0, 0.0], [6.0, 1.0], [6.0, 0.0], [5.0, 1.0]]),
    np.array([[2.29, -0.54], [3.71, -0.54], [3.0, -1.24], [3.0, 0.17]]),
    np.array([[1.13, 4.23], [4.73, 4.0], [2.0, 4.73], [2.63, 1.63]]),
    np.array([[1.29, -0.17], [2.64, -0.59], [1.76, -1.06], [2.17, 0.3]]),
    np.array([[0.70, 0.18], [2.06, -0.24], [1.17, -0.7], [1.59, 0.65]]),
]
